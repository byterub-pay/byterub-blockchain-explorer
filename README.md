...
git clone https://github.com/byterub-pay/byterub-blockchain-explorer.git
...
Go to your browser: http://127.0.0.1:9091
...
xmrblocks, ByteRub Blockchain Explorer:
  ...
  --ssl-key-file arg                    path to key file for ssl (https) 
                                        functionality
  -d [ --deamon-url ] arg (=http:://127.0.0.1:19091)
                                        ByteRub deamon url
```
